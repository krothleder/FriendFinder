...
*Friend Finder* is deployed to Heroku. Please check it out [here](https://friendsfinder2124.herokuapp.com/).

## Installation

To install the application follow the instructions below:

	git clone git@github.com:krothleder/FriendFinder.git
	cd FriendFinder
	npm install
